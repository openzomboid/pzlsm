...
* `pzmanifest` - Удаляет файл `projectzomboid/steamapps/appmanifest_380870.acf`. Иногда при обновлении игры возникает ошибка скачивания обновления сервера. Удаление файла манифеста позволяет выполнить принудительное обновление игры во время запуска сервера.

      ./server.sh delfile modmanifest
* 
* `modmanifest` - Удаляет файл `projectzomboid/steamapps/workshop/appworkshop_108600.acf`. Иногда при обновлении мода в мастерской PZ не замечает этого и не обновляет мод при запуске сервера. Удаление файла манифеста позволяет выполнить принудительное обновление модов из мастерской Steam во время запуска сервера.
